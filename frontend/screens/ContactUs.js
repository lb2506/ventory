  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        Alert.alert("Message envoyé !", "Merci de nous avoir contacté, nous traiterons votre message dès que possible.", [
          {
            text: "OK",
      ...
      Alert.alert("Erreur", "Un problème est survenu lors de l'envoi de votre message, merci de réessayer.", [
        {
          text: "OK",
        },
      ]);
    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        <Text style={styles.explain}>
          Besoin d'aide ? Une question ? Nous sommes là pour vous ! N'hésitez pas à nous contacter en utilisant le formulaire ci-dessous. Nous vous
          répondrons dès que possible. Nous sommes impatients de vous lire !
        </Text>
