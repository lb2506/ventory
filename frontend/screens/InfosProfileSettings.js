  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.photoPseudo}>
        <PhotoPseudo pictureSize={150} pseudoSize={20} pseudoName={userData?.pseudo} pictureUrl={profilePicture} pseudoVisible={false} />
      ...
      <View style={styles.formContainer}>
        ...
        <TextInput style={styles.input} value={email} onChangeText={setEmail} placeholder="Adresse email" />
        <TextInput style={styles.input} value={phone} onChangeText={setPhone} placeholder="Numéro de téléphone" />
        <TextInput
          style={styles.input}
          value={password}
      ...
      <ModalAddPicture visible={bottomAddClotheSheetVisible} setVisible={setBottomAddClotheSheetVisible} isProfilePicture={true} />
    </View>
  );
};
