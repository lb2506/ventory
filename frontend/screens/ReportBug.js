...
const ReportBug = () => {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      Alert.alert("Message envoyé !", "Merci de nous avoir contacté, nous reviendrons vers vous dès que possible.", [
        {
          text: "OK",
    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        <Text style={styles.explain}>
          Aidez-nous à améliorer notre application ! Utilisez le formulaire ci-dessous pour nous communiquer les détails du bug que vous avez
          rencontré. Nous apprécions votre coopération et nous nous engageons à résoudre les problèmes signalés le plus rapidement possible.
        </Text>
        <View>
