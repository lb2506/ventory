...
const ReportBug = () => {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            Alert.alert(
                "Message envoyé !",
                "Merci de nous avoir contacté, nous reviendrons vers vous dès que possible.",
                [
                    {
                        text: "OK",
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.explain}>
                ...
                Utilisez le formulaire ci-dessous pour nous communiquer les détails du bug que vous avez rencontré.
                Nous apprécions votre coopération et nous nous engageons à résoudre les problèmes signalés le plus rapidement possible.
            </Text>
            <View>
                <TextInput
                    style={styles.input}
